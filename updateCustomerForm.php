    ...
    <h2>แก้ไขมูลลูกค้าเข้าฐานข้อมูล1<h2>
            <form action="updateCustomerDB.php" method="POST">
                <form>
                    ...
                    <input type="text" placeholder="กรุณากรอกรหัสลูกค้า" name="CustomerID" value="<?php echo $result_customer['CustomerID'] ?>"readonly>
                    <br> <br>
                    ...
                    <select name="CountryCode" id="CountryCode">
                        ...
                        foreach ($cc as $c) {
                            if ($selected == $c['CountryName']) {
                                ...
                                echo '<option selected value="'   . '">' .  $result_customer["CountryName"] . '</option>';
                            } else {
                                echo '<option value="'  . '">' .  $c["CountryName"] . '</option>';
                            }
                        }
                        ?>
